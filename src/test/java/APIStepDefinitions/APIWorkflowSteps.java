...
public class APIWorkflowSteps {
    ...
    //making a request with usual pauload
    ...
    public void the_employee_id_is_stored_as_a_global_variable_to_be_used_for_other_calls(String empId) {
        //string the employee id in global variable
    ...
    public void the_employee_data_we_get_having_id_must_match_with_globally_stored_employee_id(String string) {
        //it will store the employee id coming from get call which will be compared to global
        String tempEmId = response.jsonPath().getString(string);
        //assertion will add
